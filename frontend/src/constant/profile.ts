...
export const DefaultRoute = (): IRoute => ({
  rules: [
    ...
    },
    {
      id: sampleID(),
      type: RuleType.RuleSet,
      payload: DefaultRulesetIds.GEOSITE_IR,
      invert: false,
      action: RuleAction.Route,
      outbound: DefaultOutboundIds.Direct,
      sniffer: [],
    ...
    },
    {
      id: sampleID(),
      type: RuleType.RuleSet,
      payload: DefaultRulesetIds.GEOIP_IR,
      invert: false,
      action: RuleAction.Route,
      outbound: DefaultOutboundIds.Direct,
      sniffer: [],
  ...
  rule_set: [
    ...
    {
      id: DefaultRulesetIds.GEOIP_IR,
      type: RulesetType.Remote,
      tag: DefaultRulesetIds.GEOIP_IR,
      format: RulesetFormat.Binary,
    ...
    {
      id: DefaultRulesetIds.GEOSITE_IR,
      type: RulesetType.Remote,
      tag: DefaultRulesetIds.GEOSITE_IR,
      format: RulesetFormat.Binary,
